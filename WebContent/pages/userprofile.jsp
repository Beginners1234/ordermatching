        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Sakshi Goel</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Orders placed</b> <a class="pull-right" href="C:\Users\Grad\Downloads\AdminLTE-2.4.4\AdminLTE-2.4.4\userorderhistory.jsp">56</a>
                </li>
                <li class="list-group-item" >
                  <b>Trades done</b> <a class="pull-right" href="C:\Users\Grad\Downloads\AdminLTE-2.4.4\AdminLTE-2.4.4\usertradehistory.jsp">50</a>
                </li>            
              </ul>
